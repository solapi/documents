...
```json
{
    "pfId": "PF01ID191028182813137kdVzYLIXwXT",
    "name": "회원가입",
...
```json
{
    ...
    "content": "#{홍길동}님 회원가입을 환영 합니다.",
    "dateCreated": "2019-10-28T18:28:14.390Z",
    "dateUpdated": "2019-10-28T18:28:14.390Z",
    "templateId": "KA01TP191028182814391LF1KtCRmSna"
}
```
...
var options = {
  ...
  body: {
    pfId: 'PF01ID191028182813137kdVzYL...',
    name: '회원가입',
    content: '#{홍길동}님 회원가입을 환영 합니다.'
  },
  method: 'POST',
...
<?php
$url = "http://api.solapi.com/kakao/v1/templates/daou";
$data = '{"pfId":"PF01ID191028182813137kdVzYL...","name":"회원가입","content":"#{홍길동}님 회원가입을 환영 합니다."}';
...
curl -X POST \
	...
	-d '{"pfId":"PF01ID191028182813137kdVzYL...","name":"회원가입","content":"#{홍길동}님 회원가입을 환영 합니다."}' \
...
func main() {
  ...
  data := strings.NewReader(`{"pfId":"PF01ID191028182813137kdVzYL...","name":"회원가입","content":"#{홍길동}님 회원가입을 환영 합니다."}`)
...
public class Request {
  public static void main(String[] args) throws Exception {
    ...
    String parameters = "{\"pfId\":\"PF01ID191028182813137kdVzYL...\",\"name\":\"회원가입\",\"content\":\"#{홍길동}님 회원가입을 환영 합니다.\"}";
