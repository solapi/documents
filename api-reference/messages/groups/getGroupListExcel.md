...
```
http://api.solapi.com/messages/v4/groups/excel?criteria=dateCreated&value=2021-11-16%2014:09:41&cond=lt&limit=25
```
...
```php
<?php
$url = "http://api.solapi.com/messages/v4/groups/excel?criteria=dateCreated&value=2021-11-16%2014:09:41&cond=lt&limit=25";
...
uri = URI.parse("http://api.solapi.com/messages/v4/groups/excel?criteria=dateCreated&value=2021-11-16%2014:09:41&cond=lt&limit=25")
...
func main() {
  uri := "http://api.solapi.com/messages/v4/groups/excel?criteria=dateCreated&value=2021-11-16%2014:09:41&cond=lt&limit=25"
...
public class Request {
  public static void main(String[] args) throws Exception {
    String targetUrl = "http://api.solapi.com/messages/v4/groups/excel?criteria=dateCreated&value=2021-11-16%2014:09:41&cond=lt&limit=25";
