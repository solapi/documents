...
{
    "amount": 10000,
    "paymentId": "10441095726930861001569566268361"
}
```
...
```json
{
    ...
    "pointAmount": 0,
    "type": "RECHARGE",
    "historyId": "5d8dae3cfa0c8a4a7543bfe7"
}
```
...
var options = {
  ...
  body: {
    amount: 10000,
    paymentId: '104410957269308610015695662...'
  },
  method: 'POST',
  json: true,
...
<?php
$url = "http://api.solapi.com/cash/v1/balance";
$data = '{"amount":10000,"paymentId":"104410957269308610015695662..."}';
...
curl -X POST \
	...
	-d '{"amount":10000,"paymentId":"104410957269308610015695662..."}' \
...
func main() {
  ...
  data := strings.NewReader(`{"amount":10000,"paymentId":"104410957269308610015695662..."}`)
...
public class Request {
  public static void main(String[] args) throws Exception {
    ...
    String parameters = "{\"amount\":10000,\"paymentId\":\"104410957269308610015695662...\"}";
