...
{
    "amount": 10000,
    "paymentId": "85522924192871301569566935701"
}
```
...
```json
{
    ...
    "pointAmount": 0,
    "type": "RECHARGE",
    "historyId": "5d8db0d756a6c025cd29673f"
}
```
...
<?php
$url = "http://api.solapi.com/cash/v1/balance";
$data = '{"amount":10000,"paymentId":"85522924192871301569566935701"}';
...
curl -X POST \
	...
	-d '{"amount":10000,"paymentId":"85522924192871301569566935701"}' \
...
func main() {
  ...
  data := strings.NewReader(`{"amount":10000,"paymentId":"85522924192871301569566935701"}`)
...
public class Request {
  public static void main(String[] args) throws Exception {
    ...
    String parameters = "{\"amount\":10000,\"paymentId\":\"85522924192871301569566935701\"}";
