...
```json
{
    "mail": {
        ...
        "messageTime": 602,
        "messageSize": 927,
        "response": "250 Accepted [STATUS=new MSGID=XCm9j2EZlw0y9P3eXT-ttHBtNSvIykt6AAAdZ9CIwBnMmpDRxs4ZYQsydmI]",
        "envelope": {
        ...
        "messageId": "<94f02ad7-d204-9f30-aba8-be582759aef1@coolsms.zendesk.com>"
    }
}
```
