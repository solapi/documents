...
```json
{
    "mail": {
        ...
        "messageTime": 600,
        "messageSize": 927,
        "response": "250 Accepted [STATUS=new MSGID=XCm9j2EZlw0y9P3eXTqw6SAaGyvGdr.9AAAdOnnDPzBr8xBo1XGS9c4PONo]",
        "envelope": {
        ...
        "messageId": "<2405dd99-13cc-a07d-7fe1-029dd6a4cfed@coolsms.zendesk.com>"
    }
}
```
