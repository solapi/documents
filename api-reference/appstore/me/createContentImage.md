...
{
    "appId": "lAnktXtQ0fox",
    "imageName": "Xf6QItdLM2IsQLm.png",
    "imageUrl": "https://coolsms-apps-test.s3.ap-northeast-2.amazonaws.com/lAnktXtQ0fox/screenshots/Xf6QItdLM2IsQLm.png",
    "originalName": "Xf6QItdLM2IsQLm.png"
}
```
...
var options = {
  ...
  json: true,
  url:
    'http://api.solapi.com/appstore/v2/me/apps/lAnktXtQ0fox/images/screenshots'
};
...
```php
<?php
$url = "http://api.solapi.com/appstore/v2/me/apps/lAnktXtQ0fox/images/screenshots";
...
uri = URI.parse("http://api.solapi.com/appstore/v2/me/apps/lAnktXtQ0fox/images/screenshots")
...
func main() {
  uri := "http://api.solapi.com/appstore/v2/me/apps/lAnktXtQ0fox/images/screenshots"
...
public class Request {
  public static void main(String[] args) throws Exception {
    String targetUrl = "http://api.solapi.com/appstore/v2/me/apps/lAnktXtQ0fox/images/screenshots";
