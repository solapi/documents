...
관련 정보는 [http://www.coolsms.co.kr/SenderID\_API를](http://www.coolsms.co.kr/SenderID_API를) 참고해주세요. postRequest\('register', data, 'senderid'\)로 요청을 해서 넘어오는 ars\_number로 전화를 걸어주시면 됩니다.
