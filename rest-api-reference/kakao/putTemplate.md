...
```json
{
    "pfId": "PF01ID190612070959149nCc0Byq4ay9",
    "name": "회원가입",
...
```json
{
    ...
    "comments": [],
    "content": "#{홍길동}님 회원가입을 환영 합니다.",
    "dateCreated": "2019-06-12T06:10:00.246Z",
    "dateUpdated": "2019-06-12T06:10:00.246Z",
    "templateId": "KA01TP1906120710002458YCFJVoMezL"
}
```
...
var options = {
  ...
  body: {
    pfId: 'PF01ID190612070959149nCc0By...',
    name: '회원가입',
    content: '#{홍길동}님 회원가입을 환영 합니다.'
  },
  method: 'POST',
...
```php
$url = "http://api.solapi.com/kakao/v1/templates";
$data = array("pfId" => "PF01ID190612070959149nCc0By...", "name" => "회원가입", "content" => "#{홍길동}님 회원가입을 환영 합니다.");
...
data = {"pfId":"PF01ID190612070959149nCc0By...","name":"회원가입","content":"#{홍길동}님 회원가입을 환영 합니다."}
...
curl -X POST \
	...
	-d pfId=PF01ID190612070959149nCc0By... \
	-d name=회원가입 \
...
func main() {
  ...
  data := strings.NewReader(`{"pfId":"PF01ID190612070959149nCc0By...","name":"회원가입","content":"#{홍길동}님 회원가입을 환영 합니다."}`)
...
public class Request {
  public static void main(String[] args) throws Exception {
    ...
    String parameters = "pfId=PF01ID190612070959149nCc0By...&name=회원가입&content=#{홍길동}님 회원가입을 환영 합니다.";
